...
- Discord: darmush
- GitHub: [github.com/darmush](https://github.com/darmush "darmush")
...
**Специалистка технической поддержки** 2025–2026  
Компания Starter. Обработка обращений клиентов в Helpdesk от приёма до решения, диагностика сбоев (логи, API, Postman), настройка системы в админ-панели, работа с CRM, взаимодействие с партнёрами по интеграциям (iiko, R-Keeper); автоматизация процессов скриптами и дашбордами в Metabase
